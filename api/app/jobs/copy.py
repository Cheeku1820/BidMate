...
RENDER_FAILED = "Couldn't draw this sheet. The takeoff still counts it."
...
PRICE_SHEET_FAILED = "The price sheet couldn't be read. Start from Download price request and upload the filled file."
