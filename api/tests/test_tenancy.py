...
TENANCY_TABLE = [
    ...
    ("GET", "/api/sheets/{sheet_id}/tiles/{z}/{x}/{y}.png",
     lambda p, s, i: f"/api/sheets/{s.id}/tiles/0/0/0.png", None, None),
    ("GET", "/api/sheets/{sheet_id}/thumb.png",
     lambda p, s, i: f"/api/sheets/{s.id}/thumb.png", None, None),
    ...
    ("POST", "/api/projects/{project_id}/takeoff",
     lambda p, s, i: f"/api/projects/{p.id}/takeoff", None, None),
    ("GET", "/api/projects/{project_id}/processing",
     lambda p, s, i: f"/api/projects/{p.id}/processing", None, None),
    ("PUT", "/api/presence",
